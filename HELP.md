...
<li>В докере подними БД.  В командной строке запущенной от имени администратора надо перейти в корневой каталог проекта (там должен лежать) и введи команду "docker-compose up -d"</li>
